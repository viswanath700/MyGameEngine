...
// Declaration of transform matrices
...
void main(
	...
	in const float2 i_texture_coords : TEXCOORD0,
	...
	// Texture coordinates containing U and V
	out float2 o_texture_coords : TEXCOORD0
...
layout( location = 1 ) out vec2 o_texture_coords;
...

{
	...
	// Pass the input texture to the fragment shader unchanged:
	{
